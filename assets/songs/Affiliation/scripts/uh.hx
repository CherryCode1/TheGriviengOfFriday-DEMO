...
function stepHit(step) {
    ...
    switch (step) {
        ...
        case 2336:
            FlxTween.tween(camGame,{zoom: 1.4}, (Conductor.stepCrochet / 1000) * 4,{ease:FlxEase.quadOut,onComplete: function uh(){
                defaultCamZoom = 1.4;
                ...
                FlxTween.tween(camGame,{zoom: 0.95}, (Conductor.stepCrochet / 1000) * 8,{ease:FlxEase.circInOut,onComplete: function uh(){
                    defaultCamZoom = 0.95;
